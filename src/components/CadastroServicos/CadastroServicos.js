  ...
  cadastrarServicos = () => {
    ...
    axios
      ...
      .then(() => {
        ...
        this.setState ({titulo:"", descricao:"", preco:"", prazoServico:""})
  ...
  // };
	...
	render (){
      ...
      <div>
			...
			<CardCadastro>
                <input placeholder ={"Título*"} value ={this.state.titulo} onChange ={this.onChangeTitulo} />
               
                <input placeholder ={"Descrição*"} value ={this.state.descricao} onChange ={this.onChangeDescricao} />
        
                <input placeholder ={"Preço: R$"} value ={this.state.preco} onChange ={this.onChangePreco} />
               
                 {listaPamentos}
               
                <input placeholder ={"AA/MM/DD"} value ={this.state.prazoServico} onChange ={this.onChangePrazoServico} />
